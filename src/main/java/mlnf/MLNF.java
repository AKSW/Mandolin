...
import mlnf.controller.Classes;
import mlnf.controller.Evidence;
import mlnf.controller.NameMapper;
import mlnf.controller.OntoImporter;
import mlnf.controller.ProbKBData;
import mlnf.controller.Validator;
import mlnf.grounding.Grounding;
import mlnf.inference.ProbKBToRockitGibbsSampling;
import mlnf.model.PredictionSet;
import mlnf.reasoner.PelletReasoner;
import mlnf.rulemining.RDFToTSV;
import mlnf.rulemining.RuleMiner;
import mlnf.util.PostgreNotStartedException;
import mlnf.util.SetUtils;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;

/**
 * The final pipeline for mlnf, a scalable join of several
...
public class MLNF {
	...
	private final static Logger logger = LogManager.getLogger(MLNF.class);
	 ...
	 * @param enableSim
	 */
	public MLNF(String workspace, String csInputPaths, String aimRelation, int thrMin, int thrStep, int thrMax, boolean enableOnt, boolean enableFwc, boolean enableSim) {
		super();
	...
	public static void main(String[] args) throws Exception {
		...
		logger.info("mlnf initialized with args = {}", Arrays.toString(args));
		...
		try {
			...
			MLNF m = new MLNF(output, input, aim, Integer.parseInt(simVal[0]), 
		...
		// TODO handle all exceptions
			...
			logger.fatal("mlnf exited with errors (-1).");
