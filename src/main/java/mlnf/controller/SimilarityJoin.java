...
import mlnf.model.Cache;
import mlnf.model.ComparableLiteral;
...
public class SimilarityJoin {
	...
	public static final String SIMILAR_PREFIX = "http://mlnf.aksw.org/ontology#similar";

	public static final String SIMILAR_TO_PREFIX = "http://mlnf.aksw.org/ontology#similarTo";
	...
	public static void build(NameMapper map,
		...
		if (useClosure) {
			...
			PelletReasoner.closure(BASE + "/model-sim.nt", BASE
					+ "/model-sim-fwc.nt");
		} else {
			try {
