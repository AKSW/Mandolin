...
import mlnf.common.NameMapperCommon.Type;
import mlnf.model.Cache;
import mlnf.model.ComparableLiteral;
import mlnf.semantifier.Commons;
import mlnf.util.URLs;
...
/**
 * mlnf for syntax used by common MLN learning frameworks (e.g., Netkit,
 * ProbCog, Alchemy, Tuffy).
 * 
 * @author author <email>
 *
 */
public class MLNFCommon {
	...
	public static final String BASE = "eval/09_publi-tuffy";
