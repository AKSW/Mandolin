...
../alchemy-2/bin/infer -maxSteps 100 -burnMaxSteps 100 -i "../alchemy-2/exdata/publications.mln" -r "../alchemy-2/exdata/publications-out.mln" -e "../alchemy-2/exdata/publications.db" -q EqualsEnt
